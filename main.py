...
from app.api.v1.admin_avatars_router import router as admin_avatars_router
...
from app.api.v1.ai_seller_router import router as ai_seller_router
from app.api.v1.ai_avatars_router import router as ai_avatars_router
from app.api.v1.avatars_router import router as avatars_router
...
app.include_router(admin_avatars_router, prefix=settings.API_V1_PREFIX)
...
app.include_router(ai_seller_router, prefix=settings.API_V1_PREFIX)
app.include_router(ai_avatars_router, prefix=settings.API_V1_PREFIX)
app.include_router(avatars_router, prefix=settings.API_V1_PREFIX)
